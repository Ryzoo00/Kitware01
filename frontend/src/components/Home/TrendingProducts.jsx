...
const TrendingProducts = () => {
  ...
  const fetchTrendingProducts = async () => {
    try {
      const response = await axios.get(`${API_URL}/products/trending?sort=-createdAt`);
      const trendingProducts = response.data.data;
      // Sort by newest first (latest uploaded products appear first)
